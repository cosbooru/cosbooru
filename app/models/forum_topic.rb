...
class ForumTopic < ApplicationRecord
  ...
  module SearchMethods
    ...
    def search(params, current_user)
      q = search_attributes(params, %i[id created_at updated_at is_sticky is_locked is_deleted category category_id title response_count creator updater forum_posts bulk_update_requests tag_aliases tag_implications], current_user: current_user)
