...
class MediaAsset < ApplicationRecord
  ...
  FILE_TYPES = %w[jpg png gif webp avif mp4 webm mov swf zip]
  FILE_MIME_TYPES = %w[image/jpeg image/png image/gif image/webp image/avif video/mp4 video/webm video/quicktime application/x-shockwave-flash video/x-ugoira]
  FILE_KEY_LENGTH = 9
  ...
  class Variant
    ...
    def open_file!(&)
      ...
      MediaFile.open(file, frame_delays: frame_delays, &)
    end
